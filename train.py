...
class Train :
    def __init__(self,root):
        ...
        img_top=Image.open( r"college_images\face5.png")
        img_top=img_top.resize(( 1850,325 ),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)
        
        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x =0,y =55,width=1850,height =325)
        ...
        img_bottom=Image.open( r"college_images\face -3.jpg")
        img_bottom=img_bottom.resize(( 1850,325 ),Image.ANTIALIAS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)
        
        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x =0,y =450,width=1850,height =325)
